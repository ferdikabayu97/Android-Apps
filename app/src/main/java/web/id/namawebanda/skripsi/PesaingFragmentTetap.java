...
public class PesaingFragmentTetap extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_pesaing_tetap, container , false);
        ...
        try {
            ...
            PesaingTetapDataModel status = PesaingTetapDataModel.fromJson(response);
